...
def read_xml_input(filepaths, parsed=False):
    ...
    elem = ET.Element('Sentence')
    text_tag = ET.SubElement(elem, 'Text')
    parse_tag = ET.SubElement(elem, 'Parse')
    text_tag.text = """The stopover came as the US leader prepared to attend the Beijing Olympics, an 
    event which will test his vow to keep politics out of the Games."""
    parse_tag.text = """( (S 
    (NP (DT The) (NN stopover)) 
    (VP (VBD came) (SBAR (IN as) (S 
    (NP (DT the) (NNP US) (NN leader)) 
    (VP (VBD prepared) (S 
    (VP (TO to) 
    (VP (VB attend) 
    (NP (NP (DT the) (NNP Beijing) (NNP Olympics)) (, ,) 
    (NP (NP (DT an) (NN event)) (SBAR (WHNP (WDT which)) (S 
    (VP (MD will) 
    (VP (VB test) 
    (NP (PRP$ his) (NN vow) (S 
    (VP (TO to) 
    ...
    (PP (IN out) 
    (PP (IN of) 
    (NP (DT the) (NNPS Games))))))))))))))))))))) (. .)))"""
    # body.set("bgcolor", "#ffffff")
    elem.set("date", "20080804")
    elem.set("id", "AFP0808020625_4")
    elem.set("source", "AFP")
    elem.set("sentence", "True")

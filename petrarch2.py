...
def main():
    ...
    # paths = ['/home/stephen4166/test.xml']
 ...
 # meta is the metadata for event coding
    ...
    meta = 0
    # pre = meta[id].split("_")[0]
    out = ".txt"  # PETRglobals.EventFileName
    # if cli_args.outputs:
...
def run(meta, out_file, s_parsed):
    # this is the routine called from main()
    events = PETRreader.read_xml_input(meta, s_parsed)
    if not s_parsed:
